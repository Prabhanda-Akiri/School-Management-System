...
<?php 
  ...
  if ($no_rows > 0) 
  {
    while($row = mysqli_fetch_assoc($result)) 
    {
       ...
       echo '<td><input type="text" id="hgrade" name="hgrade" placeholder="Grade" required /></td>';
      
       echo '<td><input type="text" id="agrade" name="agrade" placeholder="Grade" required /></td>';
       ...
       if(isset( $_POST['submit_btn'] ))
       {
        ...
        // echo "$_POST[hgrade]";
          ...
          if($no_rows2>0){
          $q1="UPDATE student_grades set hgrade='$_POST[hgrade]' where sid='$row[sid]' and course_id='$row[cid]'";
          $result1 = mysqli_query($con,$q1);
          $q1="UPDATE student_grades set agrade='$_POST[agrade]' where sid='$row[sid]' and course_id='$row[cid]'";
          $result1 = mysqli_query($con,$q1);
