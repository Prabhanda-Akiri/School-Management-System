...
<h2 class="heading"><b>ADD TEACHER</b></h2>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="teachername" name="tname" placeholder=" Enter Teacher Name" required />
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="teachermobile" name="tmobile" placeholder="Enter Mobile-no" required />
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="teacheremail" name="temail" placeholder="Enter Email" required />
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="teachercourse" name="tcourse" placeholder="Enter Course" required />
      </div>
    </div>
